...
class Tempo_p extends CI_Controller {
   ...
   public function __construct()
   {
      ...
      $this->load->model(array('Products_model'=>'produk', 'Tempo_model'=>'tempo','Transaksi_model' => 'transaksi', 'Pembelian_model' => 'pembelian'));
	...
	{  
      ...
      $this->template->backend('tempo_p', $data);
	}
   ...
   public function view()
   {
     ...
     $query = $this->tempo
         ->with_barang('fields:namabarang')
         ->where('subtransaksiID', $id)
         ->get();

      $data = array();
      if($query){
         $data = array('subtransaksiID' => $query->subtransaksiID,
                        'barangID' => $query->barang->namabarang,
   ...
   public function form_data()
   {
      ...
      if($this->input->post('subtransaksiID')){
         ...
         $query   = $this->tempo
                  ->with_products('fields:HargaJual')
                  ->where('subtransaksiID', $id)->get_all(); 
         if($query){
            $row = array(
            'subtransaksiID' => $query->subtransaksiID,
            'ProdukID'     => $query->ProdukID,
      ...
      $data = array(
             'subtransaksiID' => form_input(array('name'=>'subtransaksiID', 'id'=>'datepicker', 'class'=>'form-control', 'value'=>$query->subtransaksiID)),
             'ProdukID' => form_input(array('name'=>'ProdukID', 'id'=>'datepicker', 'class'=>'form-control', 'value'=>$query->ProdukID)),
             'HargaJual' => form_input(array('name'=>'HargaJual', 'id'=>'datepicker', 'class'=>'form-control', 'value'=>$query->products->HargaJual)),
             'jumlahbeli' => form_input(array('name'=>'jumlahbeli', 'id'=>'datepicker', 'class'=>'form-control', 'value'=>$row->jumlahbeli)),
             'totalharga' => form_input(array('name'=>'totalharga', 'id'=>'datepicker', 'class'=>'form-control', 'value'=>$row->totalharga))
